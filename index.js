...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Orang Tampan😎\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=62881957416:+62 881-954-7416\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
memberlimit = 0
cr = '🤖Diwid bot🤖 '*BOT INI SUDAH TERVERIFIKASI*'
/*************************************/

/******** OWNER NUMBER**********/
const ownerNumber = ["628819547416@s.whatsapp.net","62881947416@s.whatsapp.net"] 
/************************************/
